...
| **`disableScreenshots`** | <code>boolean</code>                                                            | Configure whether the plugin should disable/enable the possibility of taking screenshots. Only available for iOS.                                           | <code>true</code>     |
